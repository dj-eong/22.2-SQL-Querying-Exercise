...
-- 8
SELECT * FROM analytics WHERE min_installs <= 50 AND rating BETWEEN 0 AND 5 ORDER BY rating DESC;
...
-- 15
SELECT app_name, reviews, min_installs, min_installs/reviews AS min_installs_per_reviews FROM analytics WHERE min_installs >= 100000 ORDER BY min_installs/reviews DESC LIMIT 1;